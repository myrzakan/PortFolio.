var api = require('gulp-notify/lib/extra_api');
...
// Expose plugin
module.exports = disable ? noopStream : require('gulp-notify/lib/notify');
...
// Syntactiv sugar
module.exports.withReporter = disable ? fn(noopStream) : require('gulp-notify/lib/withReporter');
